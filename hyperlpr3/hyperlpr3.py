...
class LicensePlateCatcher(object):
    ...
    def __init__(self, inference: int = INFER_ONNX_RUNTIME, folder=_DEFAULT_FOLDER_, detect_level=DETECT_LEVEL_LOW):
        if inference == INFER_ONNX_RUNTIME:
            ...
            cls = ClassificationORT(join(folder, ort_cfg['cls_model_path']))
